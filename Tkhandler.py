...
#button 设置
connect_btn = Button(root,text="打开连接",fg="white",command=connect)
connect_btn.place(x=80,y=66,width=80,height=24)
disconnect_btn = Button(root,text="断开连接",fg="white",command=disconnect)
...
def show_led(msg):
    if msg == "on":
        closestate = Label(root,bg="white")
